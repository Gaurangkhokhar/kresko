...
export default function Home() {
  ...
  // Industries Served Details (shared catalog — see src/data/industries.js)
  const industries = INDUSTRIES_SERVED;
  ...
  return (
    <div>
      ...
      <section id="home-industries" className="section" style={{ backgroundColor: 'var(--color-bg-light)', borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)' }}>
        <div className="container">
          <div className="section-header">
            <h2>
